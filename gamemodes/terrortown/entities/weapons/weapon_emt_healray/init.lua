...
function HEALRAY:Heal(ply, t)
	...
	if ConVarExists("ttt_emt_hot_initial") then
		healInitial = GetConVar("ttt_emt_hot_initial"):GetInt()
	end
	
	if ConVarExists("ttt_emt_hot_amount") then
		healAmount = GetConVar("ttt_emt_hot_amount"):GetInt()
	end
