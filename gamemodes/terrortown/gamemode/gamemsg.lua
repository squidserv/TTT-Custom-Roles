...
function GM:PlayerCanHearPlayersVoice(listener, speaker)
	...
	if speaker:IsActiveTraitor() or speaker:IsActiveHypnotist() or speaker:IsActiveAssassin() or speaker:IsActiveZombie() or speaker:IsActiveVampire() then
		if speaker.traitor_gvoice then
			return true, loc_voice:GetBool()
		elseif listener:IsActiveTraitor() or listener:IsActiveHypnotist() or listener:IsActiveAssassin() or listener:IsActiveZombie() or listener:IsActiveVampire() then
			return true, false
		else
