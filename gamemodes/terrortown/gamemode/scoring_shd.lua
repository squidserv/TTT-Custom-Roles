...
function ScoreEventLog(events, scores, traitors, detectives, hypnotists, mercenaries, jesters, phantoms, glitches, zombies, vampires, swappers, assassins, killers, emts)
	for k, s in pairs(scores) do
		...
		scores[k].was_emt = table.HasValue(emts, k)
	end
