...
function SCORE:HandleSelection()
	...
	for k, ply in pairs(player.GetAll()) do
		...
		elseif ply:GetEMT() then
			table.insert(emts, ply:SteamID())
		end
	end
...
function SCORE:ApplyEventLogScores(wintype)
	...
	local scored_log = ScoreEventLog(self.Events, scores, traitors, detectives, hypnotists, mercenaries, jesters, phantoms, glitches, zombies, vampires, swappers, assassins, killers, emts)
	local ply = nil
